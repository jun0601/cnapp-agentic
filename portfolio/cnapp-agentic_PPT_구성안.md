...
[레이아웃] 왼쪽 = 대시보드 스크린샷 1장(assets/shot-console-dashboard.png) · 오른쪽 = 카드 4장을 세로로 쌓기. 각 카드 = 하나의 박스(카드 제목 + 그 안에 화면별 불릿 1줄씩). ⚠️ 카드끼리는 불릿 아님(각각 별개 박스), 불릿은 카드 '안'에만. 대괄호 [...] 라벨은 위치 안내라 슬라이드엔 넣지 않는다.
