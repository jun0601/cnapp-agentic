...
> 남은 임시 배정 근거(역할표 기준): 10=엔진 Evidence 준형 / 13=조치·WAF·JWT 준형 / 15=비용·인프라 준형 / 19=공동이라 진우. **분량**: 준형 4·5·6·7·9·10·13·15·16(9장) / 진우 1·2·3·8·11·12·14·17·19(9장) / 미정 18·20. 균형.
>
> ⚠️ **14번(인프라 설계)은 준형→진우로 이관**(2026-07-21). **단, `▶ 캔바에 그대로 넣을 카피` 블록은 이미 작성돼 있으므로 진우는 그대로 만들면 된다**(새로 쓸 필요 없음).
...
> - `▶` 블록이 채워진 슬라이드 = **4·5·6·7·9·10·13·14·15·16·18**(준형 작성). 이 중 **14번은 진우가 제작**하되 카피는 이미 있으니 그대로 쓰면 된다. 나머지(1·2·3·8·11·12·17·19·20)는 산문 설명 기준으로 진우가 작성.
>
