...
### 10. 에이전틱 엔진 — 5단계 능동 조사 루프 (이 프로젝트의 핵심 차별점)
...
**[레이아웃 스케치]** — 5단계 흐름이 주인공이라 **가로 흐름 1줄을 상단에 크게**, 그 아래를 좌우로 나눈다.
```
┌────────────────────────────────────────────────────────────┐
│ ① Orchestrator → ② Triage → ③ Hypothesis → ④ Evidence → ⑤ Reasoning │  ← 가로 5단계(주인공)
│   지휘·조립      비용게이트      가설생성      tool-use(핵심)   판정·내러티브   │     ④를 시각적으로 강조
└────────────────────────────────────────────────────────────┘
┌───────────────────────────┬────────────────────────────────┐
