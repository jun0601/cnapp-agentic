...
- ▶ 다음: **Azure CIEM 스캐너**(`scanners/` Entra ID — Prowler entra_id_* mock 봉투화) · 워크로드 스캐너 나머지(Inspector·kube-bench, infra apply 후) · App Registration(SSO)(infra/console 선행) · Defender(데모 때만)
