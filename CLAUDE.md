...
- ▶ 다음: **Phase2 = 실 end-to-end 한 줄** — 스캐너 1개(진우 Trivy) 실 finding → 정규화 → 엔진 → attack-path → 콘솔 연결. *(준형 희망 = 인프라/CI-CD 먼저 — Phase1 끝났으니 Phase2 vs 인프라/CI-CD 순서는 객관 판단으로 조율)* → console-backend(TS Lambda)
